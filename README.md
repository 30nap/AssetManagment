...
run.bat                   اجرا با دوبار کلیک (ویندوز)
run.command               اجرا با دوبار کلیک (مک/لینوکس)
...
### ساده‌ترین راه: دوبار کلیک

| سیستم‌عامل | فایل |
|---|---|
| ویندوز | `run.bat` |
| مک / لینوکس | `run.command` |
...
> روی مک، بار اول ممکن است لازم باشد `run.command` را با کلیک راست ← Open باز کنید تا Gatekeeper اجازه دهد. روی لینوکس، اگر فایل‌منیجر اجرا نکرد، از ترمینال `./run.command` را بزنید.
